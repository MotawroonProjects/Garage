...
public class Fragment_Maintenance_Truck extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_maintenance_truck,container,false);
        initView(view);
        return view;
    }

    public static Fragment_Maintenance_Truck getInstance()
    {
        return new Fragment_Maintenance_Truck();
    }
    ...
    private void initView(View view) {
        ...
        if (userModel==null)
        {
            getData("all",country_id, Tags.type_maintenance_trucks);
        }else
        {
            getData(userModel.getUser_id(),country_id, Tags.type_maintenance_trucks);
