...
public class Fragment_Maintenance_Motorcycle extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_maintenance_motorcycle,container,false);
        initView(view);
        return view;
    }

    public static Fragment_Maintenance_Motorcycle getInstance()
    {
        return new Fragment_Maintenance_Motorcycle();
    }
    ...
    private void initView(View view) {
        ...
        if (userModel==null)
        {
            getData("all",country_id, Tags.type_maintenance_motorcycles);
        }else
        {
            getData(userModel.getUser_id(),country_id, Tags.type_maintenance_motorcycles);
